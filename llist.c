 ...
 *
 * Compare Function should return 0 when comparison matches
 */
...
/*
 *Foreach item in the list run a function
 */
...
/*
 * Allocates and returns a new NULL-terminated array of pointers to data elements in the list
 *
